...
interface SiderPolicyChecklistEntryProps {
  isMobile: boolean;
  isActive: boolean;
  collapsed: boolean;
...
const SiderPolicyChecklistEntry: React.FC<SiderPolicyChecklistEntryProps> = ({
  isMobile,
  isActive,
  collapsed,
  siderTooltipProps,
  ...
  if (collapsed) {
    return (
      <Tooltip {...siderTooltipProps} content={t('policyChecklist.navTitle')} position='right'>
        <div
...
export default SiderPolicyChecklistEntry;

    ...
    other: {
      ...
      conditions: [
        ...
        },
        {
          ...
          item: '奖学金等级与比例',
          description:
            '甲等每人每次1500元（评定比例不超过3%）；乙等每人每次1000元（不超过8%）；丙等每人每次500元（不超过19%）',
          type: 'info',
          quantifiable: false,
          ...
          unit: 'none',
          source_quote:
            '甲等奖学金每人每次1500元，评定比例不超过学生人数3%；乙等奖学金每人每次1000元，评定比例不超过学生人数8%；丙等奖学金每人每次500元，评定比例不超过学生人数19%。',
          source_section: '第七条',
          board: 'other',
          input_kind: 'none',
          requires_evidence: false,
        ...
        },
        {
          ...
          unit: 'none',
          source_quote:
            '（三）学院公示评审结果，公示期不少于3个工作日；……（五）学生处复核学院评审结果并公示，公示期不少于3个工作日；',
          source_section: '第九条',
          board: 'other',
          input_kind: 'none',
          requires_evidence: false,
        },
        {
          ...
          unit: 'none',
          source_quote:
            '优秀学生综合奖学金每学期评定一次，每学期开学后一个月内完成。新生入学后第一学期单独评定新生奖学金，不评定优秀学生综合奖学金。',
          source_section: '第五条',
          board: 'other',
          input_kind: 'none',
          requires_evidence: false,

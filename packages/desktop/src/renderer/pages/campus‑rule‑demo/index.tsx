...
export default function CampusRuleDemoPage() {
  const questionColumns = [
    ...
    },
    {
      ...
      dataIndex: 'scenario',
      width: 100,
      render: (s: UserQuestionSample['scenario']) => <Tag color={scenarioColorMap[s]}>{scenarioTextMap[s]}</Tag>,
    },
  ...
  return (
    <div style={{ padding: 30, maxWidth: 1100, margin: '0 auto' }}>
      ...
      <p style={{ color: '#666' }}>✅ 统一回答模板：① 结论 → ② 依据 → ③ 风险/缺失信息 → ④ 建议下一步</p>
      ...
      <Card style={{ marginBottom: 12 }}>
        <Typography.Paragraph style={{ color: '#666' }}>👤 用户问题：我想转专业，需要什么条件？</Typography.Paragraph>

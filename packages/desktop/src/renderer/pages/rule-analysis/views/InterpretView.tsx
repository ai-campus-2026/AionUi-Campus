  ...
  conditionGroups: [
    {
      ...
      label: '基础资格',
      rows: [
        { id: 'b1', item: '学籍状态', match: 'met', userValue: '在籍本科生', requirement: '具有中华人民共和国国籍且纳入全国普通高校招生计划的在籍本科生', sourceQuote: '第二条 申请国家奖学金的学生为高校在校生中二年级以上（含二年级）的学生。' },
        { id: 'b2', item: '年级要求', match: 'met', userValue: '大三', requirement: '二年级以上（含二年级）', sourceQuote: '第二条' },
        { id: 'b3', item: '思想品德', match: 'met', userValue: '无处分记录', requirement: '热爱社会主义祖国，拥护中国共产党的领导；遵守宪法和法律，遵守学校规章制度', sourceQuote: '第三条' },
      ],
    },
    {
      id: 'academic',
      label: '学业成绩',
      rows: [
        { id: 'a1', item: 'GPA成绩', match: 'met', userValue: '3.72 / 4.0', requirement: '学习成绩优异，GPA ≥ 3.5', sourceQuote: '第五条 学习成绩排名在评选范围内位于前10%。' },
        { id: 'a2', item: '专业排名', match: 'met', userValue: '5 / 120', requirement: '专业排名前10%', sourceQuote: '第五条' },
        { id: 'a3', item: '挂科情况', match: 'met', userValue: '无挂科', requirement: '无不及格科目', sourceQuote: '第六条' },
      ],
    },
    {
      id: 'english',
      label: '英语成绩',
      rows: [
        { id: 'e1', item: 'CET-4成绩', match: 'met', userValue: '512', requirement: 'CET-4 ≥ 425', sourceQuote: '第七条 外语水平要求。' },
        { id: 'e2', item: 'CET-6成绩', match: 'missing_info', userValue: '未提供', requirement: 'CET-6 ≥ 425（部分学院要求）', sourceQuote: '第七条' },
      ],
    },
    {
      id: 'comprehensive',
      label: '综合表现',
      rows: [
        { id: 'c1', item: '综合测评', match: 'met', userValue: '89 / 100', requirement: '综合测评 ≥ 85', sourceQuote: '第八条 综合素质测评成绩。' },
        { id: 'c2', item: '社会实践', match: 'missing_info', userValue: '未提供', requirement: '积极参加社会实践和志愿服务', sourceQuote: '第八条' },
      ],
    },
    {
      id: 'awards',
      label: '奖励荣誉',
      rows: [
        { id: 'aw1', item: '获奖经历', match: 'met', userValue: '校级一等奖学金', requirement: '在社会实践、创新能力、综合素质等方面表现突出', sourceQuote: '第四条' },
      ],
    },
    {
      id: 'research',
      label: '科研成果',
      rows: [
        { id: 'r1', item: '科研成果', match: 'not_met', userValue: '暂无相关成果', requirement: '至少1项相关科研成果（论文/专利/项目）', sourceQuote: '第九条 科研创新能力要求。' },
      ],
    },
  ],
  evidences: [
    { title: '《国家奖学金评定办法》2026版', snippet: '第二条 申请国家奖学金的学生为高校在校生中二年级以上（含二年级）的学生。' },
  ],
  suggestions: [
    '建议补充CET-6成绩，当前为待确认状态。',
    '建议补充科研成果，目前未满足该条件。',
  ],
}, null, 2);
...
function fieldLabelOf(key: string): string {
  const map: Record<string, string> = {
    gpa: 'GPA', grade: 'GPA', cgpa: 'GPA',
    rank: '专业排名', major_rank: '专业排名',
    cet4: 'CET-4', cet_4: 'CET-4',
    cet6: 'CET-6', cet_6: 'CET-6',
    comprehensive: '综合测评', comprehensive_score: '综合测评',
    awards: '获奖经历', honors: '获奖经历',
    research: '科研经历', research_exp: '科研经历',
    competition: '竞赛经历',
    discipline: '处分记录',
  };
  return map[key] ?? key;

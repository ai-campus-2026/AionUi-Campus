...
const PlanHistory: React.FC<Props> = ({ history, currentPlanId, onSwitch, onView, onDelete, onBatchDelete }) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className='ap-history__item-right'>
                      ...
                      {!selectMode && (
                        <button type='button' className='ap-btn ap-btn--ghost' onClick={() => onView(p)}>
                          查看
                        </button>
                      )}
                      {!selectMode && (

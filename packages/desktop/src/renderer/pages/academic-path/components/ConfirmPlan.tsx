    ...
    <div className='ap-confirm'>
      ...
      <div className='ap-confirm__body'>
        ...
        {warnings && warnings.length > 0 && (
          <div
            className={`ap-confirm__notice ${source === 'mock' ? 'ap-confirm__notice--mock' : 'ap-confirm__notice--warn'}`}
          >
            <div className='ap-confirm__notice-icon'>{source === 'mock' ? '⚠' : 'ℹ'}</div>
            <div className='ap-confirm__notice-content'>
              {warnings.map((w, i) => (
                <div key={i} className='ap-confirm__notice-text'>
                  {w}
                </div>
              ))}
            </div>
      ...
      <div className='ap-confirm__footer'>
        <button type='button' className='ap-btn ap-btn--ghost' onClick={onBack}>
          返回修改
        </button>

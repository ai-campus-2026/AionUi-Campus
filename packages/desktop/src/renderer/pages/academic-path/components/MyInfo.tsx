...
const MyInfo: React.FC<Props> = ({ plan, progress }) => {
  ...
  let totalGpaPoints = 0, totalGpaCredits = 0;
  let requiredGpaPoints = 0, requiredGpaCredits = 0;
    ...
    <div className="ap-profile-container">
      ...
      <section className="ap-profile-card">
        ...
        <div className="ap-profile-stats-grid">
          ...
          <div className="ap-profile-stat">
            <div className="ap-profile-stat-value">{earnedCredits}<span className="ap-profile-stat-total"> / {plan?.totalCredits ?? 0}</span></div>
      ...
      <section className="ap-profile-card">
        ...
        <div className="ap-profile-field">
          ...
          <input className="ap-profile-field-input" value={form.name} placeholder="请输入姓名" onChange={(e) => handleChange('name', e.target.value)} />
        </div>
        <div className="ap-profile-field">
          <span className="ap-profile-field-label">学号</span>
          <input className="ap-profile-field-input" value={form.studentId} placeholder="请输入学号" onChange={(e) => handleChange('studentId', e.target.value)} />
        </div>
        <div className="ap-profile-field">
          <span className="ap-profile-field-label">年级</span>
          <input className="ap-profile-field-input" value={form.grade} placeholder="2024级" onChange={(e) => handleChange('grade', e.target.value)} />
        </div>
        <div className="ap-profile-field">
          <span className="ap-profile-field-label">专业</span>
          <input className="ap-profile-field-input" value={form.major} placeholder="软件工程" onChange={(e) => handleChange('major', e.target.value)} />
        </div>
        <div className="ap-profile-field">
          <span className="ap-profile-field-label">班级</span>
          <input className="ap-profile-field-input" value={form.class} placeholder="请输入班级" onChange={(e) => handleChange('class', e.target.value)} />
        </div>
        <div className="ap-profile-field">
          <span className="ap-profile-field-label">专业排名</span>
          <input className="ap-profile-field-input" value={form.ranking} placeholder="如：8/120" onChange={(e) => handleChange('ranking', e.target.value)} />
        </div>
      </section>
      ...
      <section className="ap-profile-card">
        ...
        <div className="ap-profile-field">
          ...
          <input className="ap-profile-field-input" type="number" value={form.cet4} placeholder="如：425" onChange={(e) => handleChange('cet4', e.target.value)} />
        </div>
        <div className="ap-profile-field">
          <span className="ap-profile-field-label">CET-6</span>
          <input className="ap-profile-field-input" type="number" value={form.cet6} placeholder="如：520" onChange={(e) => handleChange('cet6', e.target.value)} />
        </div>
      </section>
      ...
      <section className="ap-profile-card">
        ...
        <div className="ap-profile-field">
          ...
          <input className="ap-profile-field-input" type="number" value={form.volunteerHours} placeholder="如：32" onChange={(e) => handleChange('volunteerHours', e.target.value)} />
        </div>
        <div className="ap-profile-field">
          <span className="ap-profile-field-label">获奖经历</span>
          <input className="ap-profile-field-input" value={form.awards} placeholder="如：校优秀学生干部" onChange={(e) => handleChange('awards', e.target.value)} />
        </div>
        <div className="ap-profile-field">
          <span className="ap-profile-field-label">科研经历</span>
          <input className="ap-profile-field-input" value={form.research} placeholder="如：参与校级科研项目" onChange={(e) => handleChange('research', e.target.value)} />
        </div>
      </section>
      ...
      <section className="ap-profile-card">
        ...
        <div className="ap-profile-field">
          ...
          <input className="ap-profile-field-input" value={form.target} placeholder="如：保研/考研/就业" onChange={(e) => handleChange('target', e.target.value)} />
        </div>
      </section>

      <div style={{ padding: '8px 0 24px' }}>
        <button type="button" className="ap-btn ap-btn--primary">保存信息</button>
      </div>
    </div>
  );
};
